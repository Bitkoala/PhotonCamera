...
data class RawStackSuperResolutionTuning(
    ...
    val detailRestoreStrength: Float = 0.75f,
    val fallbackMinAlignedFrames: Int = 3,
    val fallbackMinDetailFrames: Int = 1,
    val fallbackMinDetailWeightSum: Float = 0.75f,
    ...
    val registrationCoverageStart: Float = 0.82f,
    val registrationCoverageFull: Float = 0.90f,
    ...
    val detailLowLightSuppression: Float = 0.70f,
    val detailLscSuppression: Float = 0.55f,
)
